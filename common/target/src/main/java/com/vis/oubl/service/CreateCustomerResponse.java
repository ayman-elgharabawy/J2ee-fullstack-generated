...
public class CreateCustomerResponse
    implements Serializable, Comparable<CreateCustomerResponse>
{
    ...
    public boolean equals(Object object)
    {
        ...
        CreateCustomerResponse rhs = (CreateCustomerResponse) object;
     ...
     */
    @Override
    public int compareTo(CreateCustomerResponse myClass)
    {
        if (myClass==null)
        {
            return -1;
    ...
    public String toString()
    {
        return new ToStringBuilder(this)
            .append("createCustomer", this.get_Integer())
            .toString();
    }
}