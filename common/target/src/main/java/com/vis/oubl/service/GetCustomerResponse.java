 ...
 * com.vis.oubl.service.MedicalHistoryService.getCustomer()
 *
 */
...
public class GetCustomerResponse
    implements Serializable, Comparable<GetCustomerResponse>
{
    ...
    public boolean equals(Object object)
    {
        ...
        GetCustomerResponse rhs = (GetCustomerResponse) object;
     ...
     */
    @Override
    public int compareTo(GetCustomerResponse myClass)
    {
        if (myClass==null)
        {
            return -1;
    ...
    public String toString()
    {
        return new ToStringBuilder(this)
            .append("getCustomer", this.get_Object())
            .toString();
    }
}