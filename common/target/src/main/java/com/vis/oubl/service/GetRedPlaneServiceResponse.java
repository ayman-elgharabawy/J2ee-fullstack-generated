 ...
 * com.vis.oubl.service.MedicalHistoryService.getRedPlaneService()
 *
 */
...
public class GetRedPlaneServiceResponse
    implements Serializable, Comparable<GetRedPlaneServiceResponse>
{
    ...
    public boolean equals(Object object)
    {
        ...
        GetRedPlaneServiceResponse rhs = (GetRedPlaneServiceResponse) object;
     ...
     */
    @Override
    public int compareTo(GetRedPlaneServiceResponse myClass)
    {
        if (myClass==null)
        {
            return -1;
    ...
    public String toString()
    {
        return new ToStringBuilder(this)
            .append("getRedPlaneService", this.get_Object())
            .toString();
    }
}