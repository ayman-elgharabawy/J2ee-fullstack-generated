...
public class UpdateCustomerResponse
    implements Serializable, Comparable<UpdateCustomerResponse>
{
    ...
    public boolean equals(Object object)
    {
        ...
        UpdateCustomerResponse rhs = (UpdateCustomerResponse) object;
     ...
     */
    @Override
    public int compareTo(UpdateCustomerResponse myClass)
    {
        if (myClass==null)
        {
            return -1;
    ...
    public String toString()
    {
        return new ToStringBuilder(this)
            .append("updateCustomer", this.get_Integer())
            .toString();
    }
}